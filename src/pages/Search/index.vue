                ...
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a
                    ...
                    <span
                      v-show="isOne"
                      class="iconfont"
                      :class="{ 'icon-upward': isAsc, 'icon-down': isDesc }"
                    ></span>
                  </a>
                </li>
...
export default {
  ...
  methods: {
    //向服务器发请求获取search模拟数据（根据参数不同返回不同的数据进行展示）
    ...
    // 删除分类的名字
    removeCategoryName() {
      // 对象当中某一个属性值为undefined，可以不将该属性带给服务器(性能更好)
